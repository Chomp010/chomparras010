module.exports = {
    ...
    probe: { reload: 60, shudder: 0.1, damage: 0.75, speed: 3, spray: 0.1 },
    ...
    mecha:{ reload: 1.32, recoil: 0.01, shudder: 0.01, health: 1.2, damage: 1.2, pen: 1.1, speed: 1.6, maxSpeed: 1.2, spray: 1.4 },
    ...
    sprayDominator: { reload: 0.4, recoil: 0, shudder: 1.7, size: 0.5, health: 0.7, damage: 0.7, maxSpeed: 0.8, density: 0.9, spray: 2.5, resist: 0.8 },
    protectorgunner: { reload: 1.4, recoil: 0.000001, health: 100, speed: 2, maxSpeed: 2, range: 0.75, density: 5, resist: 10 },
    ...
    ventilator: { reload: 1.5, size: 0.8 },
    mothership: { reload: 1.25, pen: 1.1, speed: 0.775, maxSpeed: 0.8, range: 15, resist: 1.15 },
    droneDominator: { reload: 1.1, recoil: 0, shudder: 1.1, size: 0.5, health: 0.5, damage: 0.5, speed: 1.1, density: 0.9, spray: 1.2, resist: 0.8 },
    ...
    stabilize: { reload: 2.25, recoil: 1.8, size: 1.2, health: 1.25, damage: 1.25, pen: 1.25, speed: 1.25, maxSpeed: 1.25, spray: 1.15 },
    //redistribute: { reload: 4.75, recoil: 3, shudder: 1, size: 0.4, health: 1.85, damage: 1.85, pen: 1.9, speed: 2, maxSpeed: 1.85, density: 1, spray: 1.15, resist: 1.25 },
    obli: { reload: 2, recoil: 1.6, damage: 3, speed: 0.65, maxSpeed: 0.6, density: 1.5, resist: 1.15 },
    nesterhive: { reload: 1.6, recoil: 0.8, size: 1.24, health: 0.7, damage: 0.6, maxSpeed: 1.2 },
    ...
    bombardier: { reload: 2, recoil: 1.1, shudder: 0.8, health: 1.2, damage: 1.1, pen: 1.1, speed: 0.9, maxSpeed: 0.75, spray: 0.8 },
    nuclearbomb: { reload: 1.6, recoil: 1.1, shudder: 0.8, health: 1.4, damage: 1.2, pen: 1.2, speed: 0.9, maxSpeed: 0.75, spray: 0.8 },
    ...
    cluster: { reload: 1.4, recoil: 1.2, shudder: 1.2, health: 0.8, damage: 0.5, pen: 0.5, speed: 0.8, maxSpeed: 0.65, spray: 1.25 },
    ...
    pen: { recoil: 0.5, shudder: 1.5, health: 0.6, damage: 0.6, pen: 0.75, speed: 1.05, density: 0.9, spray: 0.75, resist: 0.7 },
    bricklayer: { reload: 2.2, size: 0.9, health: 2.2, maxSpeed: 0.9 },
    ...
    fallen: { health: 1.5, damage: 1.5, pen: 1.5, density: 2},
    fallen_overlord: { reload: 0.25, size: 0.35, health: 0.4, damage: 0.3, pen: 0.4, speed: 0.76, maxSpeed: 0.9, density: 2},

    // Special
    superpower: { recoil: 4, health: 2, damage: 2, pen: 2, density: 2, resist: 2 },
    ...
    barrier: { reload: 10, recoil: 0.001, shudder: 0.001, size: 2.2, damage: 2, speed: 0.001, maxSpeed: 0.001, spray: 0.001 },
    noRandom: { shudder: 0.00001, spray: 0.00001 },
    chainSeg: { shudder: 0.00001, spray: 0.00001, speed: 0.001, maxSpeed: 0.001 },

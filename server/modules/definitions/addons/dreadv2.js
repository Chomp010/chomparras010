...
module.exports = ({ Class }) => {
	...
	Class.androidOfficialV2 = {
	    PARENT: ["genericSquarenought"],
	    LABEL: "Android",
	    GUNS: [],
	}
	for (let i = 0; i < 4; i++) {
		Class.androidOfficialV2.GUNS.push(
			{
				POSITION: [13, 7, 1, 0, 0, 90*i, 0],
			}, {
                POSITION: [5, 10, 1, 5, 0, 90*i, 0]
            }, 
			{
				POSITION: [3.75, 7, 1.5, 13, 0, 90*i, 0],
				PROPERTIES: {
					SHOOT_SETTINGS: combineStats([g.trap, {reload: 1.4, health: 2}]),
					TYPE: "turretedTrap",
				},
			},
		)
	...
	Class.cyborgOfficialV2 = {
	    PARENT: ["genericTrinought"],
	    LABEL: "Cyborg",
	    GUNS: [],
	}
	for (let i = 0; i < 3; i++) {
		Class.cyborgOfficialV2.GUNS.push(
			{
				POSITION: [13, 10, 1, 0, 0, 120*i, 0],
			}, {
                POSITION: [5, 13, 1, 5, 0, 120*i, 0]
            }, 
			{
				POSITION: [3.5, 10, 1.4, 13, 0, 120*i, 0],
				PROPERTIES: {
					SHOOT_SETTINGS: combineStats([g.trap, g.block, {reload: 1.2, health: 2}]),
					TYPE: "unsettrapbox",
				},
			},
		)
	...
	Class.mechaOfficialV2 = {
	    PARENT: ["genericPentanought"],
	    LABEL: "Mecha",
	    GUNS: [],
	}
	for (let i = 0; i < 5; i++) {
		Class.mechaOfficialV2.GUNS.push(
			{
				POSITION: [13, 10, 1, 0, 0, 72*i, 0],
			}, {
                POSITION: [5, 13, 1, 5, 0, 72*i, 0]
            }, 
			{
				POSITION: [3.5, 10, 1.4, 13, 0, 72*i, 0],
				PROPERTIES: {
					SHOOT_SETTINGS: combineStats([g.trap, g.block, {reload: 1.4, health: 2}]),
					TYPE: "unsettrapbox",
				},
			},
		)
	...
	Class.specialTanks.UPGRADES_TIER_0.push("dreadOfficialV2");
		Class.dreadOfficialV2.UPGRADES_TIER_1 = ["swordOfficialV2", "pacifierOfficialV2", "peacekeeperOfficialV2", "invaderOfficialV2", "centaurOfficialV2"];
			...
			Class.centaurOfficialV2.UPGRADES_TIER_M1 = ["daemonOfficialV2", "minotaurOfficialV2", "androidOfficialV2"];
				...
				Class.androidOfficialV2.UPGRADES_TIER_M1 = ["cyborgOfficialV2"];
					Class.cyborgOfficialV2.UPGRADES_TIER_M1 = ["mechaOfficialV2"];

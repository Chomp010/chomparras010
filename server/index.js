...
function spawnWall(loc) {
    ...
    if (c.MAGIC_MAZE) { o.define([Class.wall, Class.whitewall, Class.blackwall, Class.redwall][ran.chooseChance(5, 0, 1, 1)]) } else { o.define(Class.wall); }
    o.team = TEAM_ROOM;
...
const bossSelections = [{
    bosses: [Class.eliteDestroyer, Class.eliteGunner, Class.eliteSprayer, Class.eliteBattleship, Class.eliteSpawner, Class.eliteTrapGuard, Class.eliteSpinner],
    location: "nest",
    amount: [3, 3, 2, 2, 2, 2, 2, 1],
    nameType: "a",
    message: "Stay focused...",
    chance: 2,
},{
    bosses: [Class.sorcerer, Class.summoner, Class.enchantress, Class.exorcistor, Class.shamanBoss],
    location: "norm",
    amount: [3, 2, 2, 2, 1],
    nameType: "a",
    ...
    bosses: [Class.fallenOverlord, Class.fallenBooster, Class.fallenHybrid, Class.fallenFalcon, Class.fallenFactory, Class.fallenOctoTank],
    location: "norm",
    amount: [3, 3, 2, 2, 2, 2, 1],
    nameType: "a",
    message: "The dead are rising...",
    chance: 2,
},{
    ...
    bosses: [Class.summoner, Class.defender, Class.fallenOverlord, Class.fallenBooster],
    location: "norm",
    amount: [2, 2, 2, 2],
    nameType: "a",
    message: "A strange trembling...",
...
const crasherConfig = {
    ...
    chance: 0.9,
    sentryChance: 0.95,
    crashers: [Class.crasher, Class.bladeCrasher, Class.invisoCrasher],
    sentries: [Class.sentryGun, Class.sentrySwarm, Class.sentryTrap,
               Class.squareGunSentry, Class.squareSwarmSentry, Class.triangleGunSentry],
};
...
let spawnPermanentBaseProtector = (loc, team) => {
    let o = new Entity(loc);
    o.define(ran.choose([Class.baseProtector, Class.baseProtectorGunner]));
    o.team = team;
...
const foodTypes = 
    ...
    /*new FoodType("Carbon Food Test",
        [Class.carbonEgg, Class.carbonSquare, Class.carbonTriangle, Class.carbonPentagon, Class.betaCarbonPentagon, Class.alphaCarbonPentagon],
        ["scale", 1], 2000
    ),
    new FoodType("Upgraded Food Test",
        [Class.egg, Class.square, Class.betaEgg, Class.triangle, Class.betaSquare, Class.alphaEgg, Class.pentagon, Class.betaTriangle, Class.alphaSquare, Class.hexagon, Class.newBetaPentagon, Class.alphaTriangle, Class.newAlphaPentagon, Class.betaHexagon, Class.alphaHexagon],
        ["scale", 0.5], 2000
    ),*/
    new FoodType("Test Food",
        [Class.egg, Class.carbonEgg, Class.square, Class.carbonSquare, Class.triangle, Class.carbonTriangle, Class.pentagon, Class.carbonPentagon, Class.hexagon, Class.carbonHexagon,
         Class.newBetaEgg, Class.betaCarbonEgg, Class.newBetaSquare, Class.betaCarbonSquare, Class.newBetaTriangle, Class.betaCarbonTriangle, Class.newBetaPentagon, Class.newBetaHexagon, Class.betaCarbonPentagon, Class.betaCarbonHexagon, 
         Class.newAlphaEgg, Class.newAlphaSquare, Class.newAlphaTriangle, Class.newAlphaPentagon, Class.newAlphaHexagon, Class.alphaCarbonEgg, Class.alphaCarbonSquare, Class.alphaCarbonTriangle, Class.alphaCarbonPentagon, Class.alphaCarbonHexagon],
        ["scale", 2], 2000
    ),/*
    new FoodType("Normal Food",
        [Class.egg, Class.square, Class.triangle, Class.pentagon, Class.newBetaPentagon, Class.newAlphaPentagon],
        ["scale", 1], 2000
    ),
    new FoodType("Beta Food",
        [Class.egg, Class.betaEgg, Class.betaSquare, Class.betaTriangle, Class.newBetaPentagon, Class.newAlphaPentagon],
        ["scale", 1], 1
    ),
    new FoodType("Alpha Food",
        [Class.egg, Class.betaEgg, Class.alphaEgg, Class.alphaSquare, Class.alphaTriangle, Class.newAlphaPentagon],
        ["scale", 1], 1
    ),
    ...
    new FoodType("Nest Food", // Commented out because stats aren't done yet.
        ...
        [Class.pentagon, Class.newBetaPentagon, Class.newAlphaPentagon],
        ["scale", 4], 1, true
    ),*/
];
